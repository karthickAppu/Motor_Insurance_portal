    ...
    const [formData, setFormData] = useState({
      ...
      const handleSearch = (event) => {
        ...
        .then((response) => {
            ...
            const[branchCode]=[response.data.policy.branchCode]
            ...
            const[customerDob]=[response.data.policy.customerDob]
            const[customerContact]=[response.data.policy.customerContact]
            const[customerEmail]=[response.data.policy.customerEmail]
            const[customerAddress]=[response.data.policy.customerAddress]
            const[customerCity]=[response.data.policy.customerCity]
            const[customerPincode]=[response.data.policy.customerPincode]

            const[vehicleNo]=[response.data.policy.vehicleNo]
            const[vehicleName]=[response.data.policy.vehicleName]
            const[vehicleMfg]=[response.data.policy.vehicleMfg]
            const[vehicleColour]=[response.data.policy.vehicleColour]
